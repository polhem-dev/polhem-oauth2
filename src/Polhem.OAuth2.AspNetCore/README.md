...
Polhem.OAuth2.AspNetCore is an ASP.NET Core library that simplifies OAuth2 authentication integration in your web applications. It supports **Google, Facebook, LINE, Azure, and Auth0** via a centralized `TOAuth2Manager` with full DI support and PKCE.
...
# Polhem.OAuth2.AspNetCore（中文）

Polhem.OAuth2.AspNetCore 是一套針對 ASP.NET Core 網站設計的 OAuth2 認證整合函式庫。透過集中式的 `TOAuth2Manager` 搭配 DI 註冊，輕鬆整合 **Google、Facebook、LINE、Azure、Auth0** 登入，並支援 PKCE 流程。
